/*
 * cash_out_orange_request.h
 *
 * 
 */

#ifndef _cash_out_orange_request_H_
#define _cash_out_orange_request_H_
...
typedef struct cash_out_orange_request_t cash_out_orange_request_t;




typedef struct cash_out_orange_request_t {
    char *full_name; // string
    int amount; //numeric
    char *phone_number; // string

} cash_out_orange_request_t;
...
#endif /* _cash_out_orange_request_H_ */
